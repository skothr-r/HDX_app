...
Peptides with valuable_sequence=1 are protected from intensity-based filters
...
DEFAULT_INPUT = os.path.join(_SCRIPT_DIR, 'data', 'comet_frags_perc_openMS_confidence_accuracy_extraction_significance_valuable_sequences.csv')
